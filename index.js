...
function addToLeft()
{
    ...
    if(subject==='' || question=='')
    {
        alert("os campos do formulário estão vazios.");
        return;
    }
...
function loadRight()
{
    ...
    h1.innerHTML="Sistema de Planejamento Pessoal:";
    var h6=document.createElement("h6");
    h6.innerHTML="Digite aqui um título para sua nova tarefa:"
    ...
    ip.setAttribute("placeholder","título");
    ip.style.width="50%";
    div1.appendChild(ip);
    ...
    textArea.setAttribute("placeholder","Descreva aqui tudo o que é preciso saber sobre sua tarefa:");
...
function discussion(clss)
{
    try{
        ...
        $("#right").append("<h5>Tarefa Agendada:</h5>");
        $("#right").append(div);
        ...
        $("#right").append("<h5 id='response'>Adcionar Comentários Extras:</h5>");
...
//------------------------------------------------------//
        ...
        $("#right").append("<h4 id='addR'>Comente Aqui:</h4>");
        ...
        ip.setAttribute("placeholder","Entre com um nome:");
        ...
        area.setAttribute("placeholder","Comente aqui:");
